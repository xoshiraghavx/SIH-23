              ...
              <div className="text-sm">
                ...
                <ul className='grid grid-cols-2 lg:grid-cols-6 mt-10 gap-4'>
                  ...
                  <Image className="rounded-full grayscale hover:grayscale-0" src={Oshi} alt="Testimonial 03" />
                    <Link href="https://www.linkedin.com/in/oshiraghav/" className=" text-center text-gray-600 transition duration-150 ease-in-out flex justify-center">Oshi Raghav</Link>
                  </li>
                  <li className="mb-1">
