            ...
            <div className="md:col-span-8 lg:col-span-7 grid">
              ...
              <div className="text-sm">
                ...
                <ul className='grid grid-cols-6 mt-10 gap-7'>
                  <li className="mb-1">
                  <Image className="rounded-full" src='https://media.licdn.com/dms/image/D4D35AQGT_FA8GjnC_w/profile-framedphoto-shrink_400_400/0/1673896187660?e=1698048000&v=beta&t=LO-_WbZyucox1SjHPhFFpU2mOWEcwKQnYuwtcDuqvAw' alt="Testimonial 03"  height={80}  width={80} />
