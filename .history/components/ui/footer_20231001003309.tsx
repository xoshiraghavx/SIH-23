          ...
          <div className="grid md:grid-cols-12 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid">
              ...
              <div className="text-sm">
                <h6 className="text-gray font-large mb-1 text-center">Meet The Team</h6>
                <ul className='flex flex-row mt-10 gap-4'>
                  <li className="mb-1">
                  <Image className="rounded-s-full" src={TestimonialImage03} alt="Testimonial 03"  height={80}  width={80} />
