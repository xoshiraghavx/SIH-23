...
import TestimonialImage03 from '../../public/images/features-03-image-01.png'
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">Unlock the future of legal simplicity with L.A.W.S. Our cutting-edge Legal Automation Workplace System revolutionizes legal processes, making them accessible and hassle-free for everyone. Say goodbye to complexity and hello to ease.</div>
            </div>

            {/* 2nd, 3rd and 4th blocks */}
            <div className="md:col-span-8 lg:col-span-7 grid gap-5">

              {/* 2nd block */}
              <div className="text-sm">
                <h6 className="text-gray font-medium mb-1 text-center">Meet The Team</h6>
                <ul className='flex flex-row mt-10'>
                  <li className="mb-1 relative inline-flex">
                  <Image className="rounded-full" src={TestimonialImage03} alt="Testimonial 03"  height={100}  />
                    <Link href="/" className=" text-center text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Harsh Vashisht</Link>
                  </li>
                  {/* <li className="mb-1">
                  <p>hi</p>
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Ujjwal Kumar</Link>
                  </li>
                  <li className="mb-1">
                  <p>hi</p>
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Aayush Pandey</Link>
                  </li>
                  <li className="mb-1">
                  <p>hi</p>
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Oshi Raghav</Link>
                  </li>
                  <li className="mb-1">
                  <p>hi</p>
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Jhankar Sethi</Link>
                  </li>
                  <li className="mb-1">
                  <p>hi</p>
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Shikha Diwakar</Link>
                  </li> */}
                </ul>
              </div>
