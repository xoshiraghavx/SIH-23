          ...
          <div className="grid md:grid-cols-12 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid">
              ...
              <div className="text-sm">
                <h6 className="text-gray-700 text-xl mb-1 text-center">Meet The Team</h6>
                <ul className='flex flex-row mt-10 gap-6'>
                  <li className="mb-1">
                  <Image className="rounded-full" src={TestimonialImage03} alt="Testimonial 03"  height={80}  width={80} />
                    <Link href="/" className="text-gray-600 transition duration-150 ease-in-out">Harsh Vashisht</Link>
                  </li>
                  <li className="mb-1">
                  <Image className="rounded-full" src={TestimonialImage03} alt="Testimonial 03"  height={80}  width={80} />
                    <Link href="/" className=" text-center text-gray-600 transition duration-150 ease-in-out">Ujjwal Kumar</Link>
                  </li>
                  <li className="mb-1">
                  <Image className="rounded-full" src={TestimonialImage03} alt="Testimonial 03"  height={80}  width={80} />
                    <Link href="/" className=" text-center text-gray-600 transition duration-150 ease-in-out">Aayush Pandey</Link>
                  </li>
                  <li className="mb-1">
                  <Image className="rounded-full" src={TestimonialImage03} alt="Testimonial 03"  height={80}  width={80} />
                    <Link href="/" className=" text-center text-gray-600 transition duration-150 ease-in-out">Oshi Raghav</Link>
                  </li>
                  <li className="mb-1">
                  <Image className="rounded-full" src={TestimonialImage03} alt="Testimonial 03"  height={80}  width={80} />
                    <Link href="/" className=" text-center text-gray-600 transition duration-150 ease-in-out">Jhankar Sethi</Link>
                  </li>
                  <li className="mb-1">
                  <Image className="rounded-full" src={TestimonialImage03} alt="Testimonial 03"  height={80}  width={80} />
                    <Link href="/" className=" text-center text-gray-600 transition duration-150 ease-in-out">Shikha Diwakar</Link>
                  </li>
                </ul>
              </div>
            </div>
