...
import Ujwal from '@/public/images/Ujwal.jpg'
import Ayush from '@/public/images/Ayush.jpg'
import Oshi from '@/public/images/Oshi.jpg'
import Jhankar from '@/public/images/Jhankar.jpg'
import Shikha from '@/public/images/Shikha.jpg'
            ...
            <div className="md:col-span-8 lg:col-span-7 grid">
              ...
              <div className="text-sm">
                ...
                <ul className='grid grid-cols-6 mt-10 gap-7'>
                  <li className="mb-1">
                  <Image className="rounded-full" src={Harsh} alt="Testimonial 03"  height={80}  width={80} />
                    <Link href="http://www.harsh.ai.in" className="text-gray-600 transition duration-150 ease-in-out mx-3"><span>Harsh</span><br/><span>Vashisht</span></Link>
                  </li>
                  <li className="mb-1">
                  <Image className="rounded-full" src={Ujwal} alt="Testimonial 03"  height={80}  width={80} />
                  ...
                  <li className="mb-1">
                  <Image className="rounded-full" src={Ayush} alt="Testimonial 03"  height={80}  width={80} />
                  ...
                  <li className="mb-1">
                  <Image className="rounded-full" src={Oshi} alt="Testimonial 03"  height={80}  width={80} />
                  ...
                  <li className="mb-1">
                  <Image className="rounded-full" src={Jhankar} alt="Testimonial 03"  height={80}  width={80} />
                  ...
                  <li className="mb-1">
                  <Image className="rounded-full" src={Shikha} alt="Testimonial 03"  height={80}  width={80} />
