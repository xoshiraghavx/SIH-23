  ...
  return (
    <footer>
      <div className="py-12 md:py-16">
        <div className=" mx-16 px-4 sm:px-6">
              ...
              <div className="text-sm">
                ...
                <ul className='grid grid-cols-6 mt-10 gap-4'>
                  ...
                  <Image className="rounded-full grayscale hover:grayscale-0" src={Harsh} alt="Testimonial 03"  />
                    <Link href="http://www.harsh.ai.in" className="text-gray-600 transition duration-150 ease-in-out flex ju ">Harsh Vashisht</Link>
                  </li>
                  <li className="mb-1">
                  ...
                  <Image className="rounded-full grayscale hover:grayscale-0" src={Ayush} alt="Testimonial 03" />
                    <Link href="https://www.linkedin.com/in/spratap0309" className="text-center text-gray-600 transition duration-150 ease-in-out text-sm">Aayush Pratap Singh Bhadoria</Link>
                  </li>
