            ...
            <div className="md:col-span-8 lg:col-span-7 grid gap-5">
              ...
              <div className="text-sm">
                ...
                <ul className='flex flex-row mt-10'>
                  <li className="mb-1">
                  <Image className="rounded-e-full" src={TestimonialImage03} alt="Testimonial 03" width={100} height={100}  />
                    <Link href="/" className="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">Harsh Vashisht</Link>
                  </li>
                  {/* <li className="mb-1">
                  <p>hi</p>
