...
import Img1 from '../../public/images/features-03-image-01.png'
      ...
      <div className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-10">

              {/* 2nd block */}
              <div className="text-sm">
                <h6 className="text-gray-200 font-medium mb-1">Meet The Team</h6>
