        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-600" data-aos="fade-up" data-aos-delay="400">
              ...
              <blockquote className="text-lg text-white grow">— Introducing LAWS, a groundbreaking innovation for clients navigating court paperwork hurdles. Now, they can effortlessly access documents online, revolutionizing the legal experience for all involved.</blockquote>
              <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                <cite className="text-gray-200 not-italic">Anastasia Dan </cite><a className="text-[#ff7c3f] transition duration-150 ease-in-out" href="#0">- UX Board</a>
              </div>
            </div>
