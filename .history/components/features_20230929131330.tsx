      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Streamline Your Success: Navigating Workflows Made Simple with Our Web App!</h2>
            <p className="text-xl text-gray-400">Streamline Your Success: Navigating Workflows Made Simple with Our Web App!</p>
          </div>
